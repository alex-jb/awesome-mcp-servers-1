...
- <img src="https://cdn.simpleicons.org/python/3776AB" height="14"/> [Orallexa Marketing Agent](https://github.com/alex-jb/orallexa-marketing-agent) - AI marketing agent for OSS founders. 7 MCP tools to draft platform-specific posts pulled from your repo's commits across X / Reddit / LinkedIn / Bluesky / Mastodon / Threads / Dev.to, with HITL approval queue, Thompson-sampling variant bandit, and Voyager-style auto-skill promotion. Install: `pip install "orallexa-marketing-agent[mcp]"`.
<br />
